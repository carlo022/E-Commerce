...
<div className="relative w-full bg-white dark:bg-gray-900 px-6 pt-10 pb-8 mt-8 shadow-xl ring-1 ring-gray-900/5 dark:ring-gray-700 sm:mx-auto sm:max-w-2xl sm:rounded-lg sm:px-10">
    <div className="mx-auto px-5">
        <div className="flex flex-col items-center">
            <h2 className="mt-5 text-center text-3xl dark:text-white font-bold tracking-tight md:text-5xl">FAQ</h2>
            <p className="mt-3 text-lg text-neutral-500 dark:text-neutral-300 md:text-xl">Frequenty asked questions
            </p>
        </div>
        <div className="mx-auto mt-8 grid max-w-xl divide-y divide-neutral-200 dark:divide-neutral-700">
            <div className="py-5">
                <details className="group">
                    ...
                    <p className="group-open:animate-fadeIn mt-3 text-neutral-600 dark:text-neutral-400">Springerdata offers a variety of
            ...
            <div className="py-5">
                <details className="group">
                    ...
                    <p className="group-open:animate-fadeIn mt-3 text-neutral-600 dark:text-neutral-400">We offer a 30-day money-back
            ...
            <div className="py-5">
                <details className="group">
                    ...
                    <p className="group-open:animate-fadeIn mt-3 text-neutral-600 dark:text-neutral-400">To cancel your subscription, you can
            ...
            <div className="py-5">
                <details className="group">
                    ...
                    <p className="group-open:animate-fadeIn mt-3 text-neutral-600 dark:text-neutral-400">We offer a free trial of our software
            ...
            <div className="py-5">
                <details className="group">
                    ...
                    <p className="group-open:animate-fadeIn mt-3 text-neutral-600 dark:text-neutral-400">If you need help with our platform or
            ...
            <div className="py-5">
                <details className="group">
                    ...
                    <p className="group-open:animate-fadeIn mt-3 text-neutral-600 dark:text-neutral-400">We may offer discounts or promotions
